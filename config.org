...
- vanilla emacs keybindings (no evil), unlike the [[https://github.com/meatcar/emacs.d][original config this was forked from]]
...
[[https://github.com/rainstormstudio/nerd-icons.el][nerd-icons]] lets emacs show pretty icons. It replaces an older package called all-the-icons, which had some missing code points when I tried it.

We also add [[https://github.com/rainstormstudio/nerd-icons-dired][nerd-icons-dired]], [[https://github.com/rainstormstudio/treemacs-nerd-icons][treemacs-nerd-icons]], and [[https://github.com/rainstormstudio/nerd-icons-completion][nerd-icons-completion]] to fancy up those features.
...
=projectile=, and =magit= integration is enabled.
...
(use-package nerd-icons-corfu
  :straight
  (nerd-icons-corfu :type git :host github
